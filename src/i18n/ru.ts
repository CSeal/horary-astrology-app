...
const ru = {
  ...
  home: {
    ...
    questionLimitBanner: 'Общий бесплатный доступ сейчас перегружен. Попробуйте немного позже или добавьте личный API-ключ в Настройках для стабильного доступа.',
    questionLimitBannerPersonal: 'Ваш личный API-ключ достиг лимита. Проверьте квоту в личном кабинете astrology-api.io.',
    charCount: '{{count}} / {{max}}',
  ...
  verdict: {
    ...
    testimonyTitle: 'Свидетельства',
    testimonyNeutral: '○ {{n}} нейтральных',
    ...
    receptionTitle: 'Рецепция',
    receptionMutual: 'ВЗАИМ.',
    receptionOneWay: 'ОДНОСТОР.',
    perfectionTitle: 'Путь перфекции',
    perfectionEnables: 'ПЕРФЕКЦИЯ',
    perfectionBlocks: 'БЛОКИРОВКА',
    keyFactorsTitle: 'Ключевые факторы',
    radicalityChecksTitle: 'Радикальность',
    radicalityShowAll: 'показать все ({{count}})',
    radicalityShowFewer: 'скрыть',
    radicalitySeverity: {
      severe: 'критично',
      moderate: 'умеренно',
      mild: 'слабо',
    },
    timingBasedOn: 'На основе: {{text}}',
    timingConfidence: {
    ...
    vocTreatmentMitigated: 'VoC смягчён аспектом',
    vocTreatmentNegation: 'VoC — карта склоняется к отказу',
    vocTreatmentIgnored: 'VoC проигнорирован — прямой аспект перфектирует',
    moonToQuesited: '☽ → {{planet}} {{aspect}} ({{deg}}°)',
    pathDirect: 'ПРЯМОЙ',
    pathSupported: 'ПОДДЕРЖАН',
    pathChallenged: 'ЗАТРУДНЁН',
    pathMixed: 'СМЕШАННЫЙ',
  },
  ...
  onboarding: {
    ...
    chronicleTitle: 'Ваша Хроника',
    chronicleBody:
      'Каждый вопрос сохраняется. Ваша хроника растёт с каждым гороскопом.',
    chroniclePoint1: 'Следите за ежедневной серией',
    chroniclePoint2: 'Пересматривайте все предсказания в журнале',
    chroniclePoint3: 'Вспоминайте вопросы этого дня прошлых лет',
    apiKeyNote:
      'astrology-api.io выполняет расчёт карты. Бесплатный ключ создаётся за минуту — или пропустите и используйте ключ приложения.',
  },
  ...
  debug: {
    ...
    replaySplash: 'Повторить сплэш-экран',
    replaySplashHint: 'Воспроизводит анимацию сплэш-экрана с начала. Полезно когда запросы разрешений или дев-меню прервали первый запуск.',
    ...
    // Demo mode section
    demoSection: 'ДЕМО ДАННЫЕ',
    demoSectionHint: 'Заполняет журнал реалистичными записями для скриншотов и тестирования.',
    demoToggle: 'Демо режим активен',
    demoToggleHint: 'Добавляет демо-записи в журнал. Выключите, чтобы их удалить.',
    demoEntryCount_one: '{{count}} демо запись',
    demoEntryCount_few: '{{count}} демо записи',
    demoEntryCount_many: '{{count}} демо записей',
    demoEntryCount_other: '{{count}} демо записей',
    demoPowerUserHint: 'Создаёт насыщенный журнал с разными вердиктами, аспектами и исходами.',
    demoPowerUserLoading: 'Загрузка…',
    demoPowerUserLabel: 'Загрузить сценарий опытного пользователя',
    demoResetHint: 'Удаляет все демо-записи и сбрасывает приложение до состояния нового пользователя.',
    demoClearingLabel: 'Очистка…',
    demoResetLabel: 'Сбросить (новый пользователь)',
    demoActivated: 'Демо режим включён',
    demoCleared: 'Демо данные очищены',
    demoPowerLoaded: 'Сценарий опытного пользователя загружен',
    demoResetDone: 'Сброс до нового пользователя',
    // Mock API additions
    forceErrorHeader: 'Принудительная ошибка',
    forceErrorNone: 'Нет',
    delayHeader: 'Задержка ответа',
    delayInstant: 'Мгновенно (0мс)',
    delayRealistic: 'Реалистично (600мс)',
    delaySlow: 'Медленно (2с)',
    // State inspector section
    inspectorSection: 'ИНСПЕКТОР СОСТОЯНИЯ',
    inspectorSectionHint: 'Снимок текущего состояния приложения в реальном времени.',
    inspectorApiKey: 'API ключ',
    inspectorApiKeySet: '✓ Установлен',
    inspectorApiKeyMissing: '✗ Отсутствует',
    inspectorJournal: 'Записи журнала',
    inspectorJournalValue: '{{total}} всего, {{demo}} демо',
    inspectorLocale: 'Язык',
    inspectorMockMode: 'Режим мока',
    inspectorMockOn: 'ВКЛ (вердикт: {{verdict}})',
    inspectorMockOff: 'ВЫКЛ',
    inspectorForceError: 'Принудит. ошибка',
    inspectorNone: 'Нет',
    inspectorQuickActions: 'Быстрые действия',
    inspectorSetApiKey: 'Установить API ключ (демо)',
    inspectorApiKeyDone: 'API ключ установлен (демо)',
    inspectorLocaleSwitch: 'Быстрое переключение языка:',
  },
