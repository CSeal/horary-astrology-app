...
const fr = {
  ...
  home: {
    ...
    questionLimitBanner: "L'accès gratuit partagé est actuellement saturé. Réessayez dans un instant, ou ajoutez votre propre clé API dans les Réglages.",
    questionLimitBannerPersonal: 'Votre clé API personnelle a atteint sa limite. Vérifiez votre quota sur astrology-api.io.',
    charCount: '{{count}} / {{max}}',
