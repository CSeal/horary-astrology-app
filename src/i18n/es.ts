...
const es = {
  ...
  home: {
    ...
    charCount: '{{count}} / {{max}}',
    locationDeniedPickCity: 'Location access denied — pick a city to continue', // TODO i18n: translate to es
    chooseCity: 'Choose city', // TODO i18n: translate to es
  },
  ...
  journal: {
    ...
    // Phase 2a — outcome tracking (TODO: translate to Spanish)
