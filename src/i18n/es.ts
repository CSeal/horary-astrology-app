...
const es = {
  ...
  home: {
    ...
    questionLimitBanner: 'El acceso gratuito compartido está saturado en este momento. Inténtalo de nuevo en breve o añade tu propia clave API en Ajustes.',
    questionLimitBannerPersonal: 'Tu clave API personal ha alcanzado su límite. Revisa tu cuota en astrology-api.io.',
    charCount: '{{count}} / {{max}}',
  ...
  settings: {
    ...
    rateApp: 'Valorar Hora',
    inviteFriendTitle: 'Compartir Hora',
    inviteShareText:
      'Uso Hora para respuestas instantáneas de astrología horaria. Pruébalo gratis:',
  },
  ...
  forceUpdate: {
    ...
    body: 'Hay una actualización crítica disponible. Actualiza la app para seguir usando Hora.',
