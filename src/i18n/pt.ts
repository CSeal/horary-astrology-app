...
const pt = {
  ...
  home: {
    ...
    questionLimitBanner: 'O acesso gratuito compartilhado está sobrecarregado agora. Tente novamente em instantes ou adicione sua própria chave de API nas Configurações.',
    questionLimitBannerPersonal: 'Sua chave de API pessoal atingiu o limite. Verifique sua cota em astrology-api.io.',
    charCount: '{{count}} / {{max}}',
