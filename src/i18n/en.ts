...
const en = {
  ...
  home: {
    ...
    questionLimitBanner: 'The free shared connection is busy right now. Try again shortly, or add your own API key in Settings for uninterrupted access.',
    questionLimitBannerPersonal: 'Your personal API key has reached its limit. Check your quota at astrology-api.io.',
    charCount: '{{count}} / {{max}}',
